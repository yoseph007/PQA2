...
Note on test count: run_tests.py executes unittest TestCase methods (currently 83 tests);
pytest discovers parametrized cases and standalone test functions individually (currently 100 items);
counts will differ.
"""
